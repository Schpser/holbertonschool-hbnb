...
class PlaceList(Resource):
    ...
    def post(self):
        ...
        print(f"📦 Place data received: {place_data}")
        
        place_data['owner_id'] = current_user_id
        place_data['amenities'] = place_data.get('amenities', [])
        print(f"🔧 Place data after processing: {place_data}")
        
        try:
            print("🎯 Calling facade.create_place...")
            new_place = facade.create_place(place_data)
            print(f"✅ Place created successfully: {new_place.id}")
...
class PlaceResource(Resource):
    ...
    def get(self, place_id):
        ...
        print(f"🔍 Looking for place: {place_id}")
